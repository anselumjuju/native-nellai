...
const Categories = () => {
  return (
    <div className='max-w-(--breakpoint-2xl) px-3 md:px-5 mx-auto space-y-12'>
      ...
      {/* Categories */}
      <div className='h-67.5 flex items-stretch justify-start lg:justify-between gap-4 overflow-x-scroll no-scrollbar'>
        {[
          { name: 'Fruits', image: '/images/fruits.webp', bg: '#032b66', fg: '#163762', href: '/categories/fruits' },
          { name: 'Lifestyle', image: '/images/lifestyle.webp', bg: '#670303', fg: '#711105', href: '/categories/lifestyle' },
          { name: 'Food', image: '/images/food.webp', bg: '#04655a', fg: '#156c56', href: '/categories/food' },
          { name: 'Household', image: '/images/household.webp', bg: '#660356', fg: '#721253', href: '/categories/household' },
          { name: 'Herbal', image: '/images/herbal.webp', bg: '#5f6704', fg: '#6a6d06', href: '/categories/herbal' },
          { name: 'Cloths', image: '/images/cloths.webp', bg: '#663303', fg: '#723d05', href: '/categories/cloths' },
        ].map((item, index) => (
          <a key={index} href={item.href} className='basis-50 flex-none h-full'>
            <div className={`rounded-xl h-full relative overflow-hidden cursor-pointer`} style={{ backgroundColor: item.bg }}>
              <svg
                width='410'
                height='508'
                viewBox='0 0 410 508'
                ...
                className='w-75 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'
        ...
        <Link href={'/categories'} className='basis-32 flex-none flex items-center justify-center bg-neutral-400 rounded-xl group'>
